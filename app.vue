...
<template>
  <NuxtLayout>
    <div
      class="text-4xl max-sm:text-3xl font-bold tracking-tight text-white text-center"
    >
      <span class="block">
        <img
          class="inline-block h-[120px] w-[120px] max-sm:h-[100px] max-sm:w-[100px] rounded-full border border-4"
          src="~/assets/img/avatar.jpg"
          alt="My beautiful self from a hike"
        />
      </span>

      <h2 class="block mt-4">Patrik Jánosdeák</h2>

      <div class="text-2xl max-sm:text-xl font-bold tracking-tight text-white">
        <div class="flex items-center">
          <span class="px-2 max-sm:text-2xl"> 👉 </span>
    ...
    <VueCard class="mt-4">
      <p
        class="mx-auto max-w-xl text-left text-lg max-sm:text-sm leading-8 text-white"
      >
        Debugging more packages than I ship at

        <VueLink
          href="https://www.mailstep.cz"
          title="Mailstep.cz website link"
        >
          mailstep.cz
        </VueLink>
      </p>
    ...
    <p
      class="mx-auto mt-4 max-w-xl text-lg max-sm:text-sm leading-8 text-white"
    >
      An ex pro-gamer wannabe turned programmer. Full-stack dev working with
      <VueLink href="https://www.typescriptlang.org/" title="TypeScript website"
        >TypeScript</VueLink
      >,
      <VueLink href="https://nodejs.org/" title="Node website">Node</VueLink>,
      <VueLink href="https://laravel.com/" title="Laravel website"
        >Laravel</VueLink
      >
      and <VueLink href="https://vuejs.org/" title="Vue website">Vue</VueLink>.
